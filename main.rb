...
parsed_response = Restaurant.api_request("https://api.resmio.com/v1/facility?near=13.383333,52.516667&distance=5000")
...
parsed_response_for_density = Restaurant.api_request("https://api.resmio.com/v1/facility?near=#{centroid[1]},#{centroid[0]}&distance=1000")
...
puts "Five closest restaurants to the centroid and their distances: "
